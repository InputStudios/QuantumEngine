...
namespace Quantum::input {
    namespace {
        constexpr u32 vk_mapping[256] {
            ...
            /* 0x91 */ input_code::key_scrolllock,
            /* 0x92 */ u32_invalid_id,
            /* 0x93 */ u32_invalid_id,
            /* 0x94 */ u32_invalid_id,
            /* 0x95 */ u32_invalid_id,
        ...
        void set_modifier_inputs(input_code::code code)
        {
            ...
            {
                set_modifier_input(VK_LMENU, input_code::key_left_shift, modifier_flags::left_alt);
                set_modifier_input(VK_RMENU, input_code::key_right_shift, modifier_flags::right_alt);
            }
        }
    ...
    HRESULT process_input_message(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
    {
        ...
        case WM_MOUSEMOVE:
        {
            math::v2 pos{ get_mouse_position(lparam) };
            ...
            set(input_source::mouse, input_code::mouse_position, { pos.x, pos.x, 0.f });
        }
        break;
        case WM_LBUTTONDOWN:
        case WM_RBUTTONDOWN:
        case WM_MBUTTONDOWN:
        {
            ...
            math::v2 pos{ get_mouse_position(lparam) };
            set(input_source::mouse, code, { pos.x, pos.x, 1.f });
        }
        break;
        case WM_LBUTTONUP:
        case WM_RBUTTONUP:
        ...
        {
            SetCapture(hwnd);
            const input_code::code code{ msg == WM_LBUTTONUP ? input_code::mouse_left : msg == WM_RBUTTONDOWN ? input_code::mouse_right : input_code::mouse_middle };
            math::v2 pos{ get_mouse_position(lparam) };
            set(input_source::mouse, code, { pos.x, pos.x, 0.f });
        }
        break;
        case WM_MOUSEWHEEL:
        {
