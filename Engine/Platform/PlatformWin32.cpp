...
namespace Quantum::platform {
    namespace {
        ...
        LRESULT CALLBACK internal_window_proc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
        {
            ...
            if (msg == HCBT_SYSCOMMAND && wparam == SC_KEYMENU)
            {
                return 0;
            }
    ...
    window create_window(const window_init_info* const init_info /* = nullptr */)
    {
        ...
        wc.lpszClassName = L"QuantumWindow";
        ...
        const wchar_t* caption{ (init_info && init_info->caption) ? init_info->caption : L"Quantum Game" };
