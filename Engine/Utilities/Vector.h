...
namespace Quantum::util {
    ...
    public:
        // Default  constructor. Doesn't allocate memory.
         ...
         // Allocate memory to contain the specified number of items.
         ...
         // Returns true number of items in the vector.
         ...
         // Indexing operator. Returns a constant to the item at specified index.
