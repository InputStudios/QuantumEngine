...
namespace {
    ...
    using _get_script_creator = Quantum::script::detail::script_creator(*)(size_t);
...
EDITOR_INTERFACE u32 LoadGameCodeDll(const char* dll_path) {
    ...
    get_script_creator = (_get_script_creator)GetProcAddress(game_code_dll, "get_script_creator_internal");
